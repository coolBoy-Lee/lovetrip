		...
		<div class="overview">
			...
			<div class="menubox">
				...
				<div id="leftmenu02" style="display:none"> <a href="infoclass.php" target="main">栏目管理</a> <a href="maintype.php" target="main">二级类别管理</a>
					<div class="hr_1"> </div>
					<a href="info.php" target="main">单页信息管理</a> <a href="infolist.php" target="main">列表信息管理</a> <a href="infoimg.php" target="main">图片信息管理</a>
					<div class="hr_1"> </div>
<!--					<a href="fragment.php" target="main">碎片数据管理</a> <a href="diymodel.php" target="main">自定义模型</a> <a href="diyfield.php" target="main">自定义字段</a> <a href="infoflag.php" target="main" title="信息标记管理" class="infoattr"></a> <a href="infosrc.php" target="main" title="信息来源管理" class="infosrc"></a>-->
                </div>
			</div>
			<div class="hr_5"></div>
			<div class="menubox">
				<div class="title" onclick="DisplayMenu('leftmenu03');" title="点击切换显示或隐藏"> 模块扩展管理 </div>
				<div id="leftmenu03" style="display:none"><a href="member.php" target="main">用户管理</a>  <a href="usercomment.php" target="main">用户评论管理</a>
					<div class="hr_1"> </div>
					<a href="message.php" target="main">留言模块管理</a>  <a href="weblink.php" target="main">友情链接管理</a> <a href="job.php" target="main">招聘模块管理</a>
					<div class="hr_1"> </div>
<!--					<a href="cascade.php" target="main">级联数据管理</a> <a href="usergroup.php" target="main" title="用户组管理" class="usertype"></a> <a href="adtype.php" target="main" title="广告位管理" class="adtype"></a> <a href="weblinktype.php" target="main" title="友情链接类别" class="weblinktype"></a>-->
			...
			<div class="hr_5"></div>
			<div class="menubox">
				<div class="title" onclick="DisplayMenu('leftmenu04');" title="点击切换显示或隐藏"> 旅游产品订单管理 </div>
				<div id="leftmenu04" style="display:none"> <a href="goodstype.php" target="main">旅游产品类别管理</a>
<!--                    <a href="goodsbrand.php" target="main">旅游产品类型管理</a> -->
                    <a href="goodsflag.php" target="main" title="商品信息属性管理" class="goodsinfoattr"></a>
					<div class="hr_1"> </div>
					<a href="goods.php" target="main">商品列表管理</a> <a href="goodsorder.php" target="main">旅游产品订单管理</a>
					<div class="hr_1"> </div>
					 <a href="paymode.php" target="main">支付方式管理</a></div>
			</div>
			<div class="hr_5"></div>
			<div class="menubox">
...
<div class="copyright"> © 2017 <a href="#" target="_blank">xxxxxx.com</a><br />
