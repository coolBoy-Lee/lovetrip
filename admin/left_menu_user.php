	...
	<div class="viewport">
		<div class="overview">
			...
			else
			{
				...
				$leftMenu04_Str = '';
				$leftMenu04_Arr = array('goodstype'=>'<a href="goodstype.php" target="main">旅游产品类别管理</a>',
									'goodsbrand'=>'<a href="goodsbrand.php" target="main">旅游产品品牌类型管理</a>',
									'goods'=>'<a href="goods.php" target="main">旅游产品列表管理</a>',
									'goodsorder'=>'<a href="goodsorder.php" target="main">旅游产品订单管理</a>',
