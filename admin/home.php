...
<div class="homeCont">
	<div class="leftArea">
		<div class="homeQuick">
			<h2 class="title">快捷<span><a href="lnk.php">More&gt;&gt;</a></span></h2>
			<div class="lnkarea">
				<?php
	...
	<div class="rightArea">
		<div class="homeEvent">
			<h2 class="title">日志<span><a href="sysevent.php">More&gt;&gt;</a></span></h2>
			<ul>
				<?php
		...
		<div class="count">
			<h2 class="title">统计<span><a href="syscount.php">More&gt;&gt;</a></span></h2>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
