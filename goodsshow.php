	...
	<div class="OneOfTwos">
		<ul class="goodstype">
			...
			if($cfg_isreurl=='Y')
				...
				$gourl = 'goods.php';
			?>
			<li class="alltype"><a href="<?php echo $gourl; ?>">全部产品类型</a></li>
			<?php
	...
	<div class="TwoOfTwos"> 
		...
		<div class="goodsConts">
			...
			<div class="goodsarea"> 
				...
				<div class="fr">
					<ul class="tb-meta">
						<li> <span>市场价</span><strong class="lt"><?php echo $row['marketprice']; ?></strong>元  / 人 </li>
						<li> <span>促销价</span><strong class="price"><?php echo $row['salesprice']; ?></strong>元 / 人</li>
						<li> <span>浏览数</span><?php echo $row['hits']; ?> 次</li>
                        <li id="special"> <label>服务承诺 &nbsp;</label><span >认证商家&nbsp;</span>
                           <span >安全交易&nbsp;</span>
                            <span>铁定成团&nbsp;</span> <span >无购物&nbsp;</span> <span >如实描述</span>
                        </li>
					</ul>
					<div class="tb-skin">
						<p class="tb-note-title"><span>产品信息</span><a href="shoppingcart.php" class="end">结算购物车</a></p>
						<form name="gform" id="gform" method="post">
							...
							&nbsp;&nbsp;人
							<div class="tb-action"> <a href="javascript:;" id="buynow" onclick="BuyNow();" title="点击此按钮，到下一步确认购买信息。">立刻预订</a> <a href="javascript:;" id="addcart" onclick="AddShoppingCart();" title="点击此按钮，将商品加入到购物车。">加入购物车</a></div>
			...
			<ul class="tabs" id="tabs">
				<li id="tabs_title0" onmouseover="Tabs('tabs',this);" class="active"><a href="javascript:;">产品描述</a></li>
				<li id="tabs_title1" onmouseover="Tabs('tabs',this);" class="normal"><a href="javascript:;">产品评价</a></li>
			</ul>
			...
			<div id="tabs_content1" class="undis">
				...
				<div class="commnet">
					<form name="form" id="form" action="" method="post">
						...
						<div class="toolbar">
							<div class="options"> 登录后才能提交留言 </div>
                            <?php if(isset($_COOKIE['username'])){?><button class="button" type="button">发 布</button>
                            <?php  }?>
						</div>
					</form>
				</div>
